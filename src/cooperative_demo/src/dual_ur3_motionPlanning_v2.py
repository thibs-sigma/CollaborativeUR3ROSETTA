...
def UR3_setup():
    ...
    # Allow some leeway in position (meters) and orientation (radians)
    arm1.set_goal_position_tolerance(0.05) # Changed from 0.01 to 0.05
    arm1.set_goal_orientation_tolerance(0.05)

    arm2.set_goal_position_tolerance(0.05) # Changed from 0.01 to 0.05
    arm2.set_goal_orientation_tolerance(0.05)
    ...
    default_joint_states_UR3_1[0] = 1.5707422494888306
