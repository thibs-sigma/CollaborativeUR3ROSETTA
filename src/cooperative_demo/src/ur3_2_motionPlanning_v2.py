...
def UR3_motionPlanning():
    ...
    arm = moveit_commander.MoveGroupCommander('UR3_2_manipulator')
    ...
    reference_frame = '/UR3_2_base_link'
...
def UR3_setup():
    ...
    default_joint_states[0] = 0.0
    default_joint_states[1] = -0.7842642664909363
    default_joint_states[2] = 0.0
    default_joint_states[3] = -0.7811948657035828
    default_joint_states[4] = -1.5707422494888306
    default_joint_states[5] = -3.1272690296173096
...
if __name__ == "__main__":
    ...
    try:
        ...
        # scene_pub = rospy.Publisher('/move_group/monitored_planning_scene', PlanningScene, queue_size=1)
        gripper_pub = rospy.Publisher('/UR3_1/gripper_command', Bool, queue_size=1)
